...
Целевая переменная(price_rent) представлена в 3х варианта, в исходном (если не устроит нормализация), а также проведеннормализация - логарифмирование(price_log) и скалирование(price_log_scaled) для снижения выбросов
...
Все признаки новые кроме ad_id - id объявления
